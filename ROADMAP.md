...
- Уточнение: заливка warning‑окна видима и сохраняет базовый градиент HUD.
- MACRO‑прогресс имеет мягкий градиент и скошенный край.
...
5. **PR#A5: Видимая заливка warning‑окна**
   - Убедиться, что danger/warn получают явную заливку фона.
   - Пульс/заливка не влияет на остальной HUD.
6. **PR#A6: MACRO‑прогресс с градиентом и скошенным краем**
   - Заменить прямую линию на прогресс‑полосу со скошенным правым краем.
   - Сделать заливку более мягкой и полупрозрачной.
